...
<body>
            ...
            <main class="content-fluid">
                <div class="page-header d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p>Perbarui konten dan tampilan untuk halaman **<?= htmlspecialchars($page['page_title']) ?>**.</p>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="pageTitle" name="page_title" value="<?= htmlspecialchars($page['page_title']) ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="pageSubtitle" name="page_subtitle" rows="2" required><?= htmlspecialchars($page['page_subtitle']) ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-column">
                                    <?php if (!empty($page['featured_image_url'])): ?>
                                        <img id="featured-image-preview" src="<?= htmlspecialchars($page['featured_image_url']) ?>" alt="Featured Image Preview">
                                    <?php else: ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="contentTitle" name="content_title" value="<?= htmlspecialchars($page['content_title']) ?>" required>
                                <small class="form-text text-muted">Judul utama konten yang muncul setelah hero section.</small>
                            </div>
                            <div class="mb-3">
                                <label for="contentSubtitle" class="form-label">Content Subtitle (Subjudul Konten)</label>
                                <textarea class="form-control" id="contentSubtitle" name="content_subtitle" rows="15" required><?= htmlspecialchars($page['content_subtitle']) ?></textarea>
    ...
    <script src="/js/admin_profile-page_edit.js"></script>
