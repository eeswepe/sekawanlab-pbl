document.addEventListener('DOMContentLoaded', function() {
    ...
    // ===================================
    const form = document.getElementById('profilePageCreateForm');
    form.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('/admin/profil-pages/create', {
                method: 'POST',
                body: formData
            });
            ...
            if (result.success) {
                ...
                alert(result.message || 'Gagal membuat halaman');
            }
        } catch (error) {
