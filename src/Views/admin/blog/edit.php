                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="postAuthor" value="<?= htmlspecialchars($blog['penulis_nama']) ?>" disabled readonly>
                                    </div>

                                    <!-- Meta Info (Read-only/Auto) -->
                                    <div class="mb-3">
                                        <label class="form-label">Estimasi Waktu Baca</label>
                                        <input type="text" class="form-control" id="metaReadingTime" value="<?= $blog['reading_time'] ?> menit" disabled readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
